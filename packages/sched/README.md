...
Schema 1.7.0: `SlotEntry` gains `spawned_at` (ISO string or null — when the CURRENTLY
...
first's, in the SAME file — `SlotEntry.log_offset_at_spawn` (schema 1.7.0, stamped
