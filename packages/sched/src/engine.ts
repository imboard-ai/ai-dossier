 ...
 * `runBatchTick`) that drives every `batch:<id>` unit (member-cycle members in
 * their own worktrees (#677) — serially, or in parallel in their own
 * `batch:<id>#<issue>` slots (#809) — the aggregate suite, the tail
