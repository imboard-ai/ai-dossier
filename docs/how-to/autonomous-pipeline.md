...
| Record a blocked batch's own MERGED PR by hand (resolves `pr-detect-ambiguous`, #824; verified same-repo/head/base, never closes the anchor) | `ai-dossier sched attach-pr 4270 --batch b1` |
