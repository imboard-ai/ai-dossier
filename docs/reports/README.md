...
| [`model-agnostic-fleet.md`](./model-agnostic-fleet.md) | Model-agnostic fleet validation (issue #528) | PARTIAL — Part I: retrospective parity holds (86% vs 86%). Part II: `model × class` axis built and populated; conformance parity sharper (glm 0/73 vs sonnet 8/150 criteria not-met); live run still NOT executed and re-escalated — #528 stays open (ac_met=0/5) | 2026-09-02 |
