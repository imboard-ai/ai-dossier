...
| `meta/publish-dossier.ds.md` | Snapshot of `imboard-ai/meta/publish-dossier` — the sign → lint → verify → publish → refresh-all-machines recipe. The registry is the source of truth; this is a copy of the latest published version |
